...
const { withBomByFileExtension, withEnhancedConflicter } = require('./decorators.js');
...
module.exports = withEnhancedConflicter(
  withBomByFileExtension([ "csproj" ], BaseGenerator)
);
